...
//endregion Overrides
    ...
    private static void renderLight( IRenderTypeBuffer buffer, MatrixStack matrix, float offset, float size, TextureAtlasSprite sprite, float[] color ) {
        ...
        RenderHelper.renderCube( buffer, matrix, offset, yTranslate, offset, size, HEIGHT_CONNECTION, size, sprite, color, FACES_NORTHWEST );
        RenderHelper.renderCube( buffer, matrix, sideTranslate, yTranslate, offset, size, HEIGHT_CONNECTION, size, sprite, color, FACES_NORTHEAST );
        RenderHelper.renderCube( buffer, matrix, offset, yTranslate, sideTranslate, size, HEIGHT_CONNECTION, size, sprite, color, FACES_SOUTHWEST );
        RenderHelper.renderCube( buffer, matrix, sideTranslate, yTranslate, sideTranslate, size, HEIGHT_CONNECTION, size, sprite, color, FACES_SOUTHEAST );
