...
public class NbtUtils {
    ...
    public static void addBlockPosToNbt( CompoundNBT nbt, BlockPos pos ) {
    ...
    public static BlockPos getBlockPosFromNbt( CompoundNBT nbt ) {
    ...
    public static void removeBlockPosFromNbt( CompoundNBT nbt ) {
